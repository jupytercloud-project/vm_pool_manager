...
func (s *Service) ExistServer(ctx context.Context, req *frontcontrolpb.UserRequest) (*frontcontrolpb.ExistData, error) {
...
func (s *Service) ExistServerPools(ctx context.Context, req *frontcontrolpb.UserRequest) (*frontcontrolpb.ExistData, error) {
...
func (s *Service) ExistConfigs(ctx context.Context, req *frontcontrolpb.UserRequest) (*frontcontrolpb.ExistData, error) {
